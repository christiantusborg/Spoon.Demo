namespace Spoon.NuGet.SecureRemotePassword.Application.Me.Email.Create
{
    ...
    /// </summary>
    public sealed class MeEmailCreateCommandHandler : IRequestHandler<MeEmailCreateEmailCommand, Either<MeEmailCreateCommandResult>>
    {
        ...
        public MeEmailCreateCommandHandler(IMockbleGuidGenerator mockbleGuidGenerator)
        {
        ...
        public async Task<Either<MeEmailCreateCommandResult>> Handle(
            MeEmailCreateEmailCommand request,
