namespace Spoon.NuGet.SecureRemotePassword.Application.User.UserGetVerifyChallenge
{
    using MediatR;
    ...
    public sealed class UserGetVerifyChallengeCommandHandler : IRequestHandler<UserGetVerifyChallengeCommand, Either<UserGetVerifyChallengeCommandResult>>
    {
        ...
        public UserGetVerifyChallengeCommandHandler(IMockbleGuidGenerator mockbleGuidGenerator)
        {
