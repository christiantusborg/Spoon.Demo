...
public static class AdministrationSetUserFailedLockoutEndpoint
{
    ...
    {
        app.MapGet(ApiAdministrationEndpoints.SetUserFailedLockout.Endpoint, async ([FromRoute] Guid userId, [FromRoute] bool value, ISender sender, CancellationToken cancellationToken) =>
            {
            ...
            .WithName(nameof(ApiAdministrationEndpoints.SetUserFailedLockout))
            .Produces(204)
