...
public static class AdministrationSetUserEmailAsPrimaryEndpoint
{
    ...
    {
        app.MapPut(ApiAdministrationEndpoints.SetUserEmailAsPrimary.Endpoint,
                async ([FromRoute] Guid userId, [FromBody] AdministrationSetUserEmailAsPrimaryRequest request, ISender sender, CancellationToken cancellationToken) =>
                {
            ...
            .WithName(nameof(ApiAdministrationEndpoints.SetUserEmailAsPrimary))
            .Produces(204)
