namespace Spoon.Demo.Application.Tests.Integration.SecureRemotePassword;
/*
using System;
...
public class SecureRemotePasswordEndpointsTests
    : IClassFixture<ApplicationApiFactory>, IAsyncLifetime
{
    private readonly ApplicationApiFactory _factory;
    private readonly List<string> _createdIsbns = new();

    public SecureRemotePasswordEndpointsTests(ApplicationApiFactory factory)
    {
    ...
    public async Task CreateBook_CreatesBook_WhenDataIsCorrect()
    {
        ...
        this._createdIsbns.Add(book.Isbn);
    ...
    {
        var httpClient = this._factory.CreateClient();
        foreach (var createdIsbn in this._createdIsbns)
        {
