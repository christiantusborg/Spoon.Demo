namespace Spoon.Demo.Application.V1.Administrator.CustomerTypes.UnDelete.V1.Endpoint;

using Spoon.Demo.Application.V1.Administrator.Categories.Create.V1.Command;
using Spoon.Demo.Application.V1.Administrator.Categories.UnDelete.V1.Command;

//public static class GetChallengeAuthentication
/// <summary>
///     Represents an endpoint for creating a new category.
/// </summary>
public class CustomerTypeUnDeleteEndpointV1 : BaseEndpoint, IEndpointMarker
{
    /// <summary>
    ...
    public IEndpointRouteBuilder Map(IEndpointRouteBuilder app)
    {
        app.MapPut(this.GetEndpointName(), EndpointHandler)
            ...
            .Produces<PermissionFailed<CategoryUnDeleteCommandV1>>(BaseHttpStatusCodes.Status401Unauthorized)
