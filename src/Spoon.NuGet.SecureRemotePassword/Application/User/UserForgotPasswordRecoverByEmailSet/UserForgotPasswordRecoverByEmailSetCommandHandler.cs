namespace Spoon.NuGet.SecureRemotePassword.Application.User.UserForgotPasswordRecoverByEmailSet
{
    ...
    /// </summary>
    public sealed class UserForgotPasswordRecoverByEmailSetCommandHandler : IRequestHandler<UserForgotPasswordSetByEmailCommand, Either<UserForgotPasswordRecoverByEmailSetCommandResult>>
    {
        ...
        public UserForgotPasswordRecoverByEmailSetCommandHandler(IMockbleGuidGenerator mockbleGuidGenerator)
        {
        ...
        public async Task<Either<UserForgotPasswordRecoverByEmailSetCommandResult>> Handle(
            UserForgotPasswordSetByEmailCommand request,
