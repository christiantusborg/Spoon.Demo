namespace Spoon.NuGet.SecureRemotePassword.Application.User.UserSubmitLoginChallenge
{
    using MediatR;
    ...
    public sealed class UserSubmitLoginChallengeCommandHandler : IRequestHandler<UserSubmitLoginChallengeCommand, Either<UserSubmitLoginChallengeCommandResult>>
    {
        ...
        public UserSubmitLoginChallengeCommandHandler(IMockbleGuidGenerator mockbleGuidGenerator)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            return new Either<UserSubmitLoginChallengeCommandResult>(new UserSubmitLoginChallengeCommandResult());
        }
    }
}